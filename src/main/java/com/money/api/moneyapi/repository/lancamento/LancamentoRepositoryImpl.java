...
import com.money.api.moneyapi.model.Lancamento_;
...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
    ...
    private void adicionarRestricaoPaginacao(TypedQuery<Lancamento> query, Pageable pageable) {
        ...
        int totalRegistroPanina = pageable.getPageSize();
        int primeiroRegistroPagina = paginaAtual * totalRegistroPanina;

        query.setFirstResult(primeiroRegistroPagina);
        query.setMaxResults(totalRegistroPanina);
    }
